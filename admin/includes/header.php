...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $basePath; ?><?php echo isset($dashboardPage) && $dashboardPage ? '../assets/css/admin-style-dashboard.css' : '../assets/css/admin-style.css'; ?>?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="<?php echo $basePath; ?>../assets/css/admin-sidebar.css?v=<?php echo time(); ?>">

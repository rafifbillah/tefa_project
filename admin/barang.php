...
</main> <!-- end .main-content (opened in sidebar.php) -->
</div> <!-- end .dashboard-wrapper (opened in sidebar.php) -->
...
.btn-primary-premium:hover { 
    background: var(--tefa-orange); 
    transform: translateY(-2px); 
}

.btn-secondary-premium {
    background: #fff; 
    color: var(--tefa-brown); 
    border: 2px solid var(--tefa-brown); 
    padding: 12px 24px; 
    border-radius: 8px;
    font-weight: 600; 
    cursor: pointer; 
...
.table-img-wrapper { 
    ...
    border-radius: 8px; 
    overflow: hidden; 
    border: 1px solid var(--tefa-border); 
}
...
.btn-toggle-action.deactivate { 
    background: #fff7ed; 
    color: #ea580c; 
}
.btn-toggle-action.deactivate:hover { 
    background: #ea580c; 
    color: #fff; 
}
.btn-toggle-action.activate { 
    background: #f0fdf4; 
    color: #16a34a; 
}
.btn-toggle-action.activate:hover { 
    background: #16a34a; 
    color: #fff; 
}
...
.image-preview-wrapper {
    ...
    width: 100px; 
    height: 100px; 
    border: 2px dashed var(--tefa-border);
    border-radius: 12px; 
    display: flex; 
    align-items: center; 
    justify-content: center;
...
/**
 * Real-time AJAX Validation for SKU & Name Uniqueness
 */
...
/**
 * Filter Table by Search Query and Category
 */
